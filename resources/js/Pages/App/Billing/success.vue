...
<template>
    <AuthenticatedLayout>
        <div class="max-w-xl mx-auto">
            <div class="card p-4">
                <div class="text-xl font-bold text-zinc-800 mb-2">
                    Your account is being upgraded...
                </div>
                <div class="font-medium text-zinc-800">
                    <p class="mb-2">
                        Thanks for upgrading your subscription! We are currently
                        in the process of upgrading your account, and you will
                        be redirected automatically in a few moments.
                    </p>
