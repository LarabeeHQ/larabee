...
const navigation = {
    solutions: [
        ...
        { name: "Sign up", href: route("register") },
    ],
    support: [
        { name: "Pricing", href: route("site.pricing") },
        { name: "Documentation", href: "https://docs.wanalytics.io" },
    ],
    company: [
        { name: "Blog", href: "#" },
    ...
    legal: [
        { name: "Privacy", href: route("site.privacy") },
        { name: "Terms", href: route("site.terms") },
    ],
    social: [
        {
            name: "Facebook",
        ...
        {
            name: "Twitter",
            href: "https://twitter.com/paulocastellano",
            icon: defineComponent({
                render: () =>
                    h("svg", { fill: "currentColor", viewBox: "0 0 24 24" }, [
                        h("path", {
            ...
            <div class="xl:grid xl:grid-cols-3 xl:gap-8">
                <div class="space-y-8">
                    ...
                    <p class="text-sm leading-6 text-gray-600">
                        The best way to build your next SaaS.
                    </p>
